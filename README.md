...
- implémenter A* qui trouve le chemin le plus court vers la solution (pour calculer les heuristiques)
- implémenter Monte Carlo (ressemble à minmax) pour le terrain donné 
